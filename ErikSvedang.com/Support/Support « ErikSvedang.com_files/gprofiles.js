...
var Gravatar = {
	...
	"build_card": function( hash, profile ) {
		...
		card = '<div id="profile-' + hash + '" class="gcard grofile"> \
...
*/
		...
		var appendix = this.active_grav_clone.css( fancyCSS ).wrap( '<a href="http://gravatar.com/' + this.active_hash + '" class="grav-clone-a" target="_blank"></a>' ).parent().css( {
			'position': 'absolute',
			'top': top + 'px',
			'left': left + 'px',
			'z-index': 15,
